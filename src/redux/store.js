...
//!! доделать 36 урок, сделать обьект стор и всё в него запихать
...
_reReanderEntireTree: function () {
},

subscribe: function (observer) {
    this._reReanderEntireTree = observer;
},
...
_postAdder: function () {
    ...
    this._reReanderEntireTree();
    this.state.profilePage.newPostText = '';
},

_updaterNewPostText: function (newText) {
...
updateNewPostText: function (newText) {
    debugger
    // console.log('this')
    return this._updaterNewPostText(newText);
}
}
